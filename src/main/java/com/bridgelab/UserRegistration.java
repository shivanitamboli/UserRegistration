...
public class UserRegistration {
	...
	public boolean validateName(String name) {
		try {
			if (name.length() == 0) {
				throw new UserRegistrationException(UserRegistrationException.ExceptionType.ENTERED_EMPTY,
	 ...
	 * have minimum 8 characters. Rule 2: Password should have at least one
	 * upper-case. Rule 3: Password should have at least one numeric value. Rule 4:
